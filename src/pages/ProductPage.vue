          ...
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            ...
            <fieldset class="form__block">
              ...
              <ColorsList
                ...
                :checkedColor.sync="checkedColorId"
              />
            </fieldset>

            <div class="item__row">
              <FormCounter class="form__counter"
      ...
      <!-- <div class="item__desc">
        ...
        <div class="item__content">
          ...
          <p>
            ...
            56 мм. На дисплей выводятся координаты и скорость, а также полученная
            со смартфона и синхронизированных датчиков информация: интенсивность,
            скорость вращения педалей, пульс и т.д. (датчики не входят в комплект
            поставки). Корпус велокомпьютера имеет степень защиты от влаги IPX7.
